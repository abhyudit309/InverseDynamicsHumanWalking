clc;
clearvars -except GRFx GRFy GRFz GRFx_ridge GRFx_lasso GRFy_ridge GRFy_lasso;
%%%
...
%%% plotting
GRFxr = zeros(133,1);
GRFxr(54:68)= GRFx_ridge(54:68);
GRFxr(69:121)= sol(69:121,1)+sol(69:121,2);
GRFxr(122:133) = GRFx_ridge(122:133);
fgrfxr = fit(tfit(1:133),GRFxr,'fourier8');
GRFxr = fgrfxr(tt);
GRFxr(1:53) = zeros(53,1);
%
GRFxl = zeros(133,1);
GRFxl(54:68)= GRFx_lasso(54:68);
GRFxl(69:121)= sol(69:121,1)+sol(69:121,2);
GRFxl(122:133) = GRFx_lasso(122:133);
fgrfxl = fit(tfit(1:133),GRFxl,'fourier8');
GRFxl = fgrfxl(tt);
GRFxl(1:53) = zeros(53,1);
figure;
plot(tt,GRFxr,'b-','LineWidth',1);
grid on;
hold on;
plot(tt,GRFxl,'m-','LineWidth',1);
plot(tt,GRFx,'r-','LineWidth',1);
xlabel('time (sec) \rightarrow');
ylabel('GRF_x (N) \rightarrow');
legend('2D Lagrangian + ridge regression','2D Lagrangian + lasso','Experimental');
%%%
GRFyr = zeros(136,1);
GRFyr(54:68)= GRFy_ridge(54:68);
GRFyr(69:121)= sol(69:121,3)+sol(69:121,4);
GRFyr(122:136) = GRFy_ridge(122:136);
fgrfyr = fit(tfit,GRFyr,'fourier8');
GRFyr = fgrfyr(tt);
GRFyr(1:53) = zeros(53,1);
%
GRFyl = zeros(136,1);
GRFyl(54:68)= GRFy_lasso(54:68);
GRFyl(69:121)= sol(69:121,3)+sol(69:121,4);
GRFyl(122:136) = GRFy_lasso(122:136);
fgrfyl = fit(tfit,GRFyl,'fourier8');
GRFyl = fgrfyl(tt);
GRFyl(1:53) = zeros(53,1);
figure;
plot(tt,GRFyr,'b-','LineWidth',1);
grid on;
hold on;
plot(tt,GRFyl,'m-','LineWidth',1);
