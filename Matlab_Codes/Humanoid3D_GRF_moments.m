...
%%% plotting
figure;
plot(tt,T5a,'r-','LineWidth',1);
grid on;
hold on;
plot(tt,T5b,'b-','LineWidth',1);
title('Hip flexion/extension moment');
% legend('3D newton','2D lagrangian');
legend('Experimental','2D lagrangian');
xlabel('time (sec) \rightarrow');
ylabel('joint moment (N-m) \rightarrow');
figure;
plot(tt,T6a,'r-','LineWidth',1);
grid on;
hold on;
plot(tt,T6b,'b-','LineWidth',1);
...
ylabel('joint moment (N-m) \rightarrow');
figure;
plot(tt,T7a,'r-','LineWidth',1);
grid on;
hold on;
plot(tt,T7b,'b-','LineWidth',1);
...
ylabel('joint moment (N-m) \rightarrow');
figure;
plot(tt,T8a,'r-','LineWidth',1);
grid on;
hold on;
plot(tt,T8b,'b-','LineWidth',1);
...
ylabel('joint moment (N-m) \rightarrow');
figure;
plot(tt,T9a,'r-','LineWidth',1);
grid on;
hold on;
plot(tt,T9b,'b-','LineWidth',1);
...
ylabel('joint moment (N-m) \rightarrow');
figure;
plot(tt,T10a,'r-','LineWidth',1);
grid on;
hold on;
plot(tt,T10b,'b-','LineWidth',1);
